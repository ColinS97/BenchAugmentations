...
python train_and_eval_pytorch.py --download --num_epochs 100 --data_flag octmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --num_epochs 100 --data_flag octmnist --augmentation randaugment