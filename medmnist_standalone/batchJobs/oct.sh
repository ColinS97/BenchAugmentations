...
python train_and_eval_pytorch.py --download --data_flag octmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag octmnist --augmentation randaugment