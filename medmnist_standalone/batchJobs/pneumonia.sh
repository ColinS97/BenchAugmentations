...
python train_and_eval_pytorch.py --download --data_flag pneumoniamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag pneumoniamnist --augmentation randaugment