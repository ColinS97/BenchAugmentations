...
python train_and_eval_pytorch.py --download --data_flag chestmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag chestmnist --augmentation randaugment