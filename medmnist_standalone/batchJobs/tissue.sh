...
python train_and_eval_pytorch.py --data_flag tissuemnist --augmentation trivialaugment
python train_and_eval_pytorch.py --data_flag tissuemnist --augmentation randaugment