...
python train_and_eval_pytorch.py --data_flag organamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --data_flag organamnist --augmentation randaugment