...
python train_and_eval_pytorch.py --download --data_flag organamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag organamnist --augmentation randaugment