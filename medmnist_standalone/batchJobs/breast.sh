...
python train_and_eval_pytorch.py --download --data_flag breastmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag breastmnist --augmentation randaugment