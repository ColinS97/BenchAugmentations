...
python train_and_eval_pytorch.py --data_flag dermamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --data_flag dermamnist --augmentation randaugment