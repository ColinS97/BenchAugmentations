...
python train_and_eval_pytorch.py --download --num_epochs 100 --data_flag dermamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --num_epochs 100 --data_flag dermamnist --augmentation randaugment