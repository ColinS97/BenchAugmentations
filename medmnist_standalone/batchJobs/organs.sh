...
python train_and_eval_pytorch.py --download --data_flag organsmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag organsmnist --augmentation randaugment