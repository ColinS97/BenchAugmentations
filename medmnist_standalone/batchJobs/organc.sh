...
python train_and_eval_pytorch.py --download --data_flag organcmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag organcmnist --augmentation randaugment