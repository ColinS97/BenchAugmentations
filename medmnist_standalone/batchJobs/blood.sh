...
python train_and_eval_pytorch.py --download --data_flag bloodmnist --augmentation trivialaugment
python train_and_eval_pytorch.py --download --data_flag bloodmnist --augmentation randaugment