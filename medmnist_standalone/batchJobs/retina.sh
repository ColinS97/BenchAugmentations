...
python train_and_eval_pytorch.py --data_flag retinamnist --augmentation trivialaugment
python train_and_eval_pytorch.py --data_flag retinamnist --augmentation randaugment